...
public class TravelPackageTest {
    ...
    @Test
    public void testPrintItinerary() {
        // Setting up the TravelPackage with destinations and activities
        TravelPackage travelPackage = new TravelPackage("Test Package", 3);
        ...
        String expectedOutput = "Travel Package: Test Package" + lineSeparator +
                ...
                "Destination: Destination 2" + lineSeparator +
                " - Activity: Activity 3, Cost: 250.0, Capacity: 20, Description: Description 3" + lineSeparator +
                "All available activities at destination :Destination 1" + lineSeparator +
                " - Activity: Activity 1, Cost: 100.0, Capacity: 10, Description: Description 1, Available spaces " + activity1.getSpaceAvailableInActivity() + lineSeparator +
                " - Activity: Activity 2, Cost: 120.0, Capacity: 15, Description: Description 2, Available spaces " + activity2.getSpaceAvailableInActivity() + lineSeparator +
                "All available activities at destination :Destination 2" + lineSeparator +
                " - Activity: Activity 3, Cost: 250.0, Capacity: 20, Description: Description 3, Available spaces " + activity3.getSpaceAvailableInActivity() + lineSeparator;
